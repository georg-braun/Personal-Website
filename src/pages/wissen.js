    ...
    hAlert = (
      <StyledAlert onClose={() => setShow(false)} dismissible>
        ...
        <p>
          ...
          Notiz-Sammlung zu diversen Themen, die mir als Nachschlagewerk dient.{" "}
        </p>
        <p>
        ...
        <p>
          ...
          Sehr wahrscheinlich sind nicht alle Notiz-Inhalte korrekt. <br></br>
          <span role="img" aria-label="wave">
            🙋
          </span>{" "}
          Feedback ist immer gerne gesehen: <strong>@</strong> ({" "}
