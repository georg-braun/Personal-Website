  ...
  <Layout title={siteTitle}>
    ...
    <ProjectContainer>
      ...
      >
                <StyledButton
          fluid
          href="https://www.npmjs.com/package/graphtodtreeconverter/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Zum Projekt
      ...
      >
                <StyledButton
          fluid
          href="https://github.com/velox1992/Study-Seminararbeit-OO-In-Der-JVM-WS1819/blob/master/Seminararbeit.pdf"
          target="_blank"
          rel="noopener noreferrer"
        >
          Zum Projekt
...
export const query = graphql`
  {
    ...
    graphtodtreeconverter: allImageSharp(
      filter: { fluid: { originalName: { regex: "/arrow-wall.jpg/" } } }
    ) {
      edges {
        node {
          fluid {
    ...
    computerGrafikArBild: allImageSharp(
      filter: {
        fluid: { originalName: { regex: "/computerGrafikArProjekt.png/" } }
      }
    ) {
      edges {
        node {
    ...
    bildverarbeitungArBild: allImageSharp(
      filter: {
        fluid: { originalName: { regex: "/bildverarbeitungArProjekt.png/" } }
      }
    ) {
      edges {
        node {
    ...
    seminararbeitJvm: allImageSharp(
      filter: { fluid: { originalName: { regex: "/seminararbeitJvm.jpg/" } } }
    ) {
      edges {
        node {
          fluid {
