...
<div class="border-solid border-0 overflow-clip rounded-md mb-10 w-3/4 mx-auto">
	<div class="flex w-ful bg-gray-800 p-2 ">
		
		<div>
			<p class="text-xl font-semibold my-auto ">{title}</p>
		</div>
		<div class="my-auto mx-4">({date})</div>
